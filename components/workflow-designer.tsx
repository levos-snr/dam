...
import { ArrowRight, CheckCircle, Clock, AlertCircle, FileText, Users, Settings, Play } from "lucide-react"
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="pt-4 space-y-2">
                  <Button className="w-full" disabled={selectedStep.status === "completed"}>

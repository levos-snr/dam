    ...
    interactions: [
      {
        ...
        hotspot: { x: 30, y: 40, w: 40, h: 25 },
      },
      {
        target: 3,
        action: "Click Workflow Tab",
        hotspot: { x: 20, y: 80, w: 15, h: 8 },
      },
    ],
  },
  {
    ...
    interactions: [
      {
        target: 3,
        action: "Click Workflow",
        hotspot: { x: 25, y: 80, w: 15, h: 8 },
      },
      {
        target: 4,
        action: "Click Documents",
        hotspot: { x: 40, y: 80, w: 15, h: 8 },
      },
      {
        target: 1,
        action: "Back to Dashboard",
        hotspot: { x: 5, y: 10, w: 10, h: 8 },
      },
    ],
  },
  {
    ...
    interactions: [
      {
        target: 5,
        action: "Click Phase",
        hotspot: { x: 20, y: 30, w: 60, h: 15 },
      },
      {
        target: 2,
        action: "Back to Overview",
        hotspot: { x: 10, y: 80, w: 15, h: 8 },
      },
    ],
  },
  {
...
export default function PrototypeFlow() {
  ...
  const currentScreenData = prototypeScreens.find(
    (screen) => screen.id === currentScreen,
  );

  const handleInteraction = (targetScreen: number, action: string) => {
    // toast({
    //   title: "Navigation",
    //   description: `${action} - Moving to ${prototypeScreens.find((s) => s.id === targetScreen)?.name}`,
    // })
  ...
  const resetPrototype = () => {
    ...
    //   description: "Returned to dashboard view",
    // })
  };
  ...
  const togglePlayMode = () => {
    ...
    // toast({
    //   title: isPlaying ? "Play Mode Stopped" : "Play Mode Started",
    //   description: isPlaying ? "Interactive hotspots enabled" : "Auto-play mode activated",
    // })
  };
        ...
        <div className="mb-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-gray-600">
              Interactive prototype demonstration for Large Dam Project
              Management System
            </p>
          </div>
          <Link href="/">
            ...
            <Card className="h-[800px]">
              ...
              <CardContent className="h-full p-0">
                <div className="relative w-full h-full bg-white border rounded-lg overflow-hidden">
                      ...
                      {currentScreen === 1 && (
                        <>
                          ...
                          <div className="flex space-x-4 mt-6">
                            <div className="px-4 py-2 bg-white rounded border text-sm">
                              Overview
                            </div>
                            <div className="px-4 py-2 bg-gray-100 rounded border text-sm">
                              Workflow
                            </div>
                            <div className="px-4 py-2 bg-gray-100 rounded border text-sm">
                              Documents
                          ...
                          <div className="bg-white rounded-lg p-4 border">
                            ...
                            <div className="space-y-3">
                              <div>
                                ...
                                <div className="text-sm text-gray-600">
                                  • Final Design Report • Construction Drawings
                  ...
                  {showHotspots &&
                    currentScreenData?.interactions.map(
                      (interaction, index) => (
                        <button
                          key={index}
                          onClick={() =>
